...
const SignUp = () => {
    ...
    return (
        <div className="flex items-center">
            <Image alt="auth image" width={720} height={1560} className="w-[57%] h-full" src="/assets/images/auth.jpeg" />
            <div className="px-12">
                ...
                <form onSubmit={handleSubmit((data: any) => {
                    ...
                    registerUser.makeRequest(() => router.push('/auth/sign-in'), () => { toast.error("Error While Creating Account") }, {
                        body: formData
                    })
                    ...
                    <div className="flex space-x-2">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center space-x-2">
                                <TextField {...register("name")} variant="standard" fullWidth label="Name" />
                                <TextField {...register("email")} variant="standard" fullWidth label="Email" />
                            </div>
                            <TextField {...register("phone")} variant="standard" fullWidth label="Phone Number" />
                        </div>
                    </div>

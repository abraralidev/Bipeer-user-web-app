...
const BillingAddress = () => {
    const billingAddress = useAxios("BILLING_ADDRESS", true)
    ...
    return (
        <div className='flex flex-col min-h-full'>
            ...
            <UserAddressModal open={open} onClose={() => { setOpen(false) }} title='Billing Address' type='CREATE_BILLING' />
        </div>
    )
}


BillingAddress.getLayout = (page: React.ReactElement) => (
    <RootLayout>
        <ProfileLayout>
            {page}
        </ProfileLayout>
